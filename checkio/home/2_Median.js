...
of numbers from the lower half. In a list where there are an odd number
of entities, the median is the number found in the middle of the array.
...
found in the middle. For this mission, you are given a non-empty array 
of natural numbers (X). With it, you must separate the upper half of 
...
function median(data) {
    ...
    const m = data.length;
    return m%2===0 ? (sorted[m/2]+sorted[m/2-1])/2: sorted[m/2-0.5]
}
